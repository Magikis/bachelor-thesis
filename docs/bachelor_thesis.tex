...
Agents developed by the author use heuristic and machine learning technics. Their implementation and performance (compared to human drivers) is described, along with contribuiton to varius subjects as function optimization, regression, classification and supevised learning.
}
